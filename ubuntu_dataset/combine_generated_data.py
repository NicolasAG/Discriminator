...
def main():
    ...
    ###
    print "\nSaving resulting dataset in %s/%s_ubuntu_bpe.pkl..." % (args.data_dir, args.data_fname_prefix)
    data_file = open("%s/%s_ubuntu_bpe.pkl" % (args.data_dir, args.data_fname_prefix), 'wb')
